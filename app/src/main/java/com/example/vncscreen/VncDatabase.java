	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		if (oldVersion < DBV_0_2_X) {
			...
			if (oldVersion == DBV_0_2_X) {
				...
				db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " RENAME TO OLD_" + AbstractConnectionBean.GEN_TABLE_NAME);
				db.execSQL(AbstractConnectionBean.GEN_CREATE);
				db.execSQL("INSERT INTO " + AbstractConnectionBean.GEN_TABLE_NAME + " SELECT *, 0 FROM OLD_" + AbstractConnectionBean.GEN_TABLE_NAME);
