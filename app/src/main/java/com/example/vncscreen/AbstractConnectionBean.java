// This class was generated from com.bobinfo.meeting.IConnectionBean by a tool
...
public abstract class AbstractConnectionBean extends com.antlersoft.android.dbimpl.IdImplementationBase implements IConnectionBean {
	...
	public static String GEN_CREATE = "CREATE TABLE CONNECTION_BEAN (" + "_id INTEGER PRIMARY KEY AUTOINCREMENT," + "NICKNAME TEXT," + "ADDRESS TEXT," + "PORT INTEGER," + "PASSWORD TEXT," + "COLORMODEL TEXT," + "FORCEFULL INTEGER," + "REPEATERID TEXT," + "INPUTMODE TEXT," + "SCALEMODE TEXT,"
			+ "USELOCALCURSOR INTEGER," + "KEEPPASSWORD INTEGER," + "FOLLOWMOUSE INTEGER," + "USEREPEATER INTEGER," + "METALISTID INTEGER," + "LAST_META_KEY_ID INTEGER," + "FOLLOWPAN INTEGER DEFAULT 0," + "USERNAME TEXT," + "SECURECONNECTIONTYPE TEXT," + "SHOWZOOMBUTTONS INTEGER DEFAULT 1,"
